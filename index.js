...
const url ="mongodb+srv://sandra:GODlifer1.@cluster0.rfc61cg.mongodb.net/?retryWrites=true&w=majority&appName=Cluster0"
...
.catch( (error) => {
    console.error(`error connecting to database. n${error}`)
})
